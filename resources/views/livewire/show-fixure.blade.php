                ...
                <div class="flex flex-col bg-white  rounded-lg text-white py-4 ">
                    ...
                    <div class="container mx-auto mb-2">
                        <div class="flex justify-around mt-2">
                            ...
                            <div class="text-gray-900 justify-around"><img src="{{ Storage::url($fixture->logo->logo)}}" class="h-10"></div>
                            <div class="text-gray-900 justify-around"><img src="{{ Storage::url($fixture->log->logo)}}" class="h-10"></div>

                        </div>

                        <div class="flex justify-around mt-2">

                            <div class="text-gray-900 text-center text-xs">{{$fixture->club->nombre}}</div>
                            <div class="text-gray-900 text-center text-xs">{{$fixture->eq->nombre}}</div>
