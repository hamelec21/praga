                                ...
                                <div class="w-full lg:w-5/6">
                                    <div class="container flex justify-center mx-auto">
                                        <div class="mr-4">
                                         ...
                                         @livewire('panel.configuraciones.tipo-serie.crear')
                                    </div>
                                </div>
                            </div>
                            <!-- show registros  -->
                                                ...
                                                @foreach($series as $serie)
                                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                        ...
                                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                                            <div class="flex items-center">
                                                            <span
                                                                class="font-medium uppercase">{{ $serie->tipo}}</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="py-3 px-6 text-center">
                                                            <div class="flex item-center justify-center">
                                                                ...
                                                                <div class="mr-2">
                                                                    @livewire('panel.configuraciones.tipo-serie.editar',['tiposerie'=>$serie],key($serie->id))
                                                                </div>

                                                                <div
                                                                    class=" mr-2  transform hover:text-purple-500 hover:scale-110">
                                                                    <a onclick="confirm('Estas Seguro de Eliminar {{$serie->tipo}}!')||event.stopImmediatePropagation()"
