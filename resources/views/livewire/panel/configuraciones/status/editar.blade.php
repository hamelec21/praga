            ...
            <div class=" rounded-lg">
                <form>
                    <div class=" text-left text-gray-900 font-bold py-1 text-sm px-4 mb-4">
                        <label class="px-2">Estatus</label>
                        <input wire:model="estado.status" type="text" name="nombre" id="" placeholder="Ejemplo(Carta Poder)"
                        ...
                        @error('status') <span class="error text-red-600 text-xs">{{ $message }}</span> @enderror
                    </div>
