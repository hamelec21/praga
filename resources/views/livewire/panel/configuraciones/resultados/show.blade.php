                                                        ...
                                                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->fechas_id }}
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->serie->nombre }}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->tipos->tipo }}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->eq->nombre }}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->resultado_local }}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->club->nombre }}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->resultado_visita }}
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->temporada->nombre }}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $resultado->estado->status }}
                                                                    </span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-center">
                                                                <div class="flex item-center justify-center">
                                                                    ...
                                                                    <div class="mr-2">
                                                                        @livewire('panel.configuraciones.resultados.editar', ['resultados' => $resultado],key($resultado->id))
