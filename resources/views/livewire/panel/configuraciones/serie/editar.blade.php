            ...
            <div class=" rounded-lg">
                <form>
                    <div class=" text-left text-gray-900 font-bold py-1 text-sm px-4 mb-4">
                        ...
                        <input wire:model="serie.nombre" type="text" name="nombre" id="" placeholder="Ejemplo(Carta Poder)"
                    ...
                    <div class=" text-left text-gray-900 font-bold py-1 text-sm px-4 mb-4">
                        ...
                        <select type="text" name="club_id" id="" placeholder="Ejemplo(Carmelo)" wire:model="serie.tipo_serie_id"
                                class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-400 w-full py-1 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                        ...
                        @error('tipo_serie_id') <span class="error text-red-600 text-xs">{{ $message }}</span> @enderror
                    </div>

                    <div class=" text-left text-gray-900 font-bold py-1 text-sm px-4 mb-4">
                        <label class="px-2">Club</label>
                        <select type="text" name="club_id" id="" placeholder="Ejemplo(Carmelo)" wire:model="serie.club_id"
                                class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-400 w-full py-1 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                            <option value="">Seleccione</option>
