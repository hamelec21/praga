                            ...
                            <div class="bg-gray-100 flex items-center justify-center  font-sans overflow-hidden">
                                <div class="w-full lg:w-5/6">
                                    <div class="container flex justify-center mx-auto">
                                        ...
                                        @livewire('panel.configuraciones.fechas.crear')
                                    </div>
                                </div>
                            </div>
                            <!-- show registros  -->
                                                ...
                                                @foreach($fechas as $fecha)
                                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                                            ...
                                                            <span
                                                                class="font-medium uppercase">{{ $fecha->id}}</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                                            <div class="flex items-center">
                                                            <span
                                                                class="font-medium uppercase">{{ $fecha->fecha}}</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                                            <div class="flex items-center">
                                                        <span
                                                            class="font-medium uppercase">{{ date('d-m-Y', strtotime($fecha->created_at)) }}</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="py-3 px-6 text-center">
                                                            <div class="flex item-center justify-center">
                                                                ...
                                                                <div class="mr-2">
                                                                    @livewire('panel.configuraciones.fechas.editar',['data'=>$fecha],key($fecha->id))
                                                                </div>

                                                                <div
                                                                    class=" mr-2  transform hover:text-purple-500 hover:scale-110">
                                                                    <a onclick="confirm('Estas Seguro de Eliminar {{$fecha->fecha}}!')||event.stopImmediatePropagation()"
                                                                       wire:click="destroy({{$fecha->id}})  ">
                                                                        <button
